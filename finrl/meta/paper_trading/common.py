    ...
    def DRL_prediction(model_name, cwd, net_dimension, environment):
        ...
        with _torch.no_grad():
            for i in range(environment.max_step):
                ...
                s_tensor = _torch.as_tensor((np_state,), dtype=torch.float32, device=device)
...
def train(
    ...
    **kwargs,
    ...
    data.to_csv('before_clean_output.csv', index=False)
    data = dp.clean_data(data)
    data.to_csv('after_clean_output.csv', index=False)
